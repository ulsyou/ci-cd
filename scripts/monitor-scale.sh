...
docker build -t 192.168.49.2:30400/monitor-scale:$BUILD_TAG -f applications/monitor-scale/Dockerfile applications/monitor-scale
...
#Push the images
docker push 192.168.49.2:30400/monitor-scale:$BUILD_TAG
...
sed 's#192.168.49.2:30400/monitor-scale:$BUILD_TAG#192.168.49.2:30400/monitor-scale:'$BUILD_TAG'#' applications/monitor-scale/k8s/deployment.yaml | kubectl apply -f -
